      ...
      mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className= {`${styles.heroHeadText} text-white`}>
            Hello! I'm <span className='text-[#915eff]'> Mustafa</span></h1>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              Aspiring Software developer, Data Scienctist <br className='sm:block hidden'/>and passionate about Machine Learning
            </p>
        </div>
      </div>
      <ComputersCanvas />
